**&---------------------------------------------------------------------*
**& Report zob_datenquellen_json_csv_dw
**&---------------------------------------------------------------------*
**&
**&---------------------------------------------------------------------*
REPORT zob_datenquellen_json_csv_dw.
...
CALL FUNCTION 'GUI_UPLOAD'
  EXPORTING
    filename = 'H:\ABAP\Schulung vor Ort Woche 2\ÜBUNG DATENQUELLEN\Datenquellen_organizations.csv'
  TABLES
...
CALL FUNCTION 'GUI_DOWNLOAD'
  EXPORTING
    filename = 'H:\ABAP\Schulung vor Ort Woche 2\ÜBUNG DATENQUELLENDatenquellen_organizations_bearbeitet.csv'
  TABLES
    data_tab = lt_csv_data.
**
*************************************************************************
