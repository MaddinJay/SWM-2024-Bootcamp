*&---------------------------------------------------------------------*
*& Report zob_programm_bl4csvjson
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zob_programm_bl4csvjson.
...
EXPORTING
filename = 'C:\Users\Loettrich.Bernd\Downloads\Datenquellen_organizations.csv'
TABLES
...
CALL FUNCTION 'GUI_DOWNLOAD'
  EXPORTING
    filename = 'C:\Users\Loettrich.Bernd\Downloads\Datenquellen_organizations2.csv'
  TABLES
    data_tab = lt_csv_data.
