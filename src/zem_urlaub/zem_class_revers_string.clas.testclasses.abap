CLASS ltcl_ZEM_class_revers_string DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT FINAL.

  PRIVATE SECTION.

    DATA cut TYPE REF TO zem_class_revers_string.
...
CLASS ltcl_zem_class_revers_string IMPLEMENTATION.
  METHOD setup.
    cut = NEW zem_class_revers_string( ).
  ENDMETHOD.
