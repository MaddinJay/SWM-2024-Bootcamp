CLASS zcl_hum_exerc_phone_number DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_hum_exerc_phone_number IMPLEMENTATION.
  METHOD clean.
    result = condense( val  = !number             "cleans numbers from spaces, brackets, etc.
                       from = '()-.+'
                       to   = '' ).
