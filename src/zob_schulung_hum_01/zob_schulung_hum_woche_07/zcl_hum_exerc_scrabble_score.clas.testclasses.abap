CLASS ltcl_hum_exerc_scrabble_score DEFINITION FOR TESTING DURATION SHORT RISK LEVEL HARMLESS FINAL.
  PRIVATE SECTION.
    DATA cut TYPE REF TO zcl_hum_exerc_scrabble_score.
    METHODS setup.
...
ENDCLASS.
CLASS ltcl_hum_exerc_scrabble_score IMPLEMENTATION.
  METHOD setup.
    cut = NEW zcl_hum_exerc_scrabble_score( ).
  ENDMETHOD.
  " lowercase letter
