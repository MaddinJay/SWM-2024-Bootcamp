@AbapCatalog.sqlViewName: 'ZOB_VW_M0_PARTN'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'View Partner'
define view ZOB_CDS_AS_BU_PARTNER
with parameters 
...
where but050.date_from <= $parameters.p_dats and but050.date_to >= $parameters.p_dats
