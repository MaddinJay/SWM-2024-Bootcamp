...
CLASS ltcl_string_reverse DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT FINAL.


  PRIVATE SECTION.

    DATA cut TYPE REF TO z_as_string_reverse.
...
CLASS ltcl_string_reverse IMPLEMENTATION.

  METHOD setup.
    cut = NEW z_as_string_reverse( ).
  ENDMETHOD.
