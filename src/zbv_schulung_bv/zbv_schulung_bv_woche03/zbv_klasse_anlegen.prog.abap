...
START-OF-SELECTION.
  ...
  go_airplane = NEW #( iv_name = 'AirBus' iv_planetype = 'Boing 787' ).    "iv_weight = 33000 iv_tankcap = 1000 ). "Objekt erstellen für Constructor, bei dieser Variante kann Exception nicht verwendet werden

*  CREATE OBJECT go_airplane "Wir verwenden diese Variante (Alte Variante um Object zu erstellen) um Exceptions anzulegen. Bei der neuen geht es nicht
*    EXPORTING
*      iv_name      = 'AirBus'
