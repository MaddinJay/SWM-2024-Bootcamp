*&---------------------------------------------------------------------*
*& Report ZBV_KOMPLEXE_DATENTYPEN
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zbv_komplexe_datentypen.
...
DATA gt_mitarbeiter2 TYPE SORTED TABLE OF lty_s_mitarbeiter WITH UNIQUE KEY pernr. "Alternativmöglichkeit für Tabellentyp
...
CLEAR gs_mitarbeiter. "Alten Mitarbieter clearen.
...
*APPEND gs_mitarbeiter TO gt_mitarbeiter2.
INSERT gs_mitarbeiter INTO TABLE gt_mitarbeiter2.
*INSERT gs_mitarbeiter INTO gt_mitarbeiter2 INDEX 1. "Man muss INDEX bei dieser Formel angeben, in dem Fall wegen pernr muss man 1 angeben
...
INSERT LINES OF gt_mitarbeiter2 FROM 1 TO 2 INTO TABLE gt_mitarbeiter. "Begrenztes Einfügen
