@AbapCatalog.sqlViewName: 'Z_OB_CDS_MB_001'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Meine erste CDS View'
define view Z_CDS_MB_001
  with parameters
    p_name : s_agncynam, //Datenelement
...
where
  stravelag.name = $parameters.p_name and sbook.fldate>= $parameters.p_datum
