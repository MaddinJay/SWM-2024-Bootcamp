...
*Kundenmethoden
    ...
    METHODS: berechnungVerbrauch IMPORTING iv_kdnr3            TYPE zob_tab_customer-cust_number
    ...
    METHODS: berechnungPreis IMPORTING iv_kdnr3         TYPE zob_tab_customer-cust_number
                                       iv_auftrnr3      TYPE zob_tab_customer-order_number
...
**********************************************************************
*Mitarbeitermethoden
    METHODS: getZaehlerstand IMPORTING iv_kdnr          TYPE zob_tab_customer-cust_number
                                       iv_auftrnr       TYPE zob_tab_customer-order_number
    ...
    METHODS: statusBestaetigen IMPORTING iv_kdnr2    TYPE zob_tab_customer-cust_number
