*&---------------------------------------------------------------------*
*& Report ZOD_KOMPLEXE_DATENTYPEN
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
...
*APPEND gs_mitarbeiter TO gt_mitarbeiter2. "Strukturdatensatz an die tabelle dranhängen
...
APPEND LINES OF gt_mitarbeiter2 TO gt_mitarbeiter. "alle Zeilen einfügen
...
MODIFY TABLE gt_mitarbeiter2 FROM gs_mitarbeiter. "Wenn P Key vorhanden
MODIFY gt_mitarbeiter2 FROM gs_mitarbeiter INDEX 2. "Wenn kein P Key vorhanden/ wenn er nicht verwendet werden soll

DELETE TABLE gt_mitarbeiter2 FROM gs_mitarbeiter. "Sucht auf Basis PK und löscht
IF sy-subrc = 0.
