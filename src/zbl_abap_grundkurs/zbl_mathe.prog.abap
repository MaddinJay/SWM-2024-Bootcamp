...
DATA: gv_zahl1       TYPE i, "normale Variablendeklaration"
      gv_dezimalzahl TYPE p DECIMALS 2 VALUE '4.20',  "Variablendeklaration mit Nachkommastelle und vordefiniertem Wert"
      gv_adresse     TYPE string.
*      gv_dezimalzahl2 LIKE gv_dezimalzahl,
*      gv_name LIKE mara-ernam.


CONSTANTS:   gc_pi TYPE p DECIMALS 2 VALUE '3.14'. "Konstnte definieren und belegen"
