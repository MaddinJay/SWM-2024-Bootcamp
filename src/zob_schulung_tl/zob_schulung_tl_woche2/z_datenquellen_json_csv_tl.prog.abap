*&---------------------------------------------------------------------*
*& Report z_datenquellen_json_csv_tl
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT z_datenquellen_json_csv_tl.
...
CALL FUNCTION 'GUI_UPLOAD'
  EXPORTING
    filename = 'C:\Users\LUKAC.TEA\Desktop\SAP Bootcamp\Woche2 Bootcamp_Denise\Datenquellen_Organization_TL.csv' "abrufen der Excel CSV Datei
  TABLES
...
DELETE lt_csv_data INDEX 1. "Wir löschen erste Zeile der Tabelle

cl_demo_output=>display( lt_csv_data ). "zeigt raw data an
...
cl_demo_output=>display( lt_organizations ). "zeigt data schön umgewandelt an, damit man es lesen kann
"---------------------------------------------------------------------------------
*"Übung: Download
...
CALL FUNCTION 'GUI_DOWNLOAD'
  EXPORTING
    filename = 'C:\Users\LUKAC.TEA\Desktop\SAP Bootcamp\Woche2 Bootcamp_Denise\Datenquellen_Organization_TL_neue.csv'
  TABLES
    data_tab = lt_csv_data.
*
**************************************************************************
