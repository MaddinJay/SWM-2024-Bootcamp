...
LOOP AT lt_grosto INTO ls_grosto.
  ...
  INTO @DATA(ls_technik).
    ...
    DATA(lv_message1) = |Hallo { ls_kunde-nachname } { ls_kunde-vorname }, im Augenblick gibt es in Ihrem Wohnbereich einen Großstörung. Wir arbeitet bereits fieberhaft an der Lösung. Ihre Ticket-ID lautet { lv_ticket }|.
