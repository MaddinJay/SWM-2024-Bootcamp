...
FORM eingabe.
  ...
  DATA(lv_message1) = |Es wurde eine Grossstörung im Postzahlenraum { p_post } aufgenommen und dem Techniker { p_tech_z-nachname } zugeordnet. Alle bestehenden und kommmenden Tickets werde Ihm zugewiesen|.
  MESSAGE lv_message1 TYPE 'I'.
  LEAVE PROGRAM.
