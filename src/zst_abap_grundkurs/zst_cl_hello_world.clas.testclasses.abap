CLASS lt_cl_Hello_world DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT FINAL.
  PRIVATE SECTION.
    DATA cut TYPE REF TO zst_cl_Hello_world.
    METHODS setup.
...
ENDCLASS.
CLASS lt_cl_hello_world IMPLEMENTATION.
  METHOD setup.
    cut = NEW zst_cl_Hello_world( ).
  ENDMETHOD.
  METHOD test_2015.
