CLASS zem_cl_car DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS: abruf IMPORTING iv_model      TYPE zem_de_car_model           "Importparameter aus Hauptprogramm
                                   ...
                                   iv_jahr       TYPE jahr
                                   iv_inspektion TYPE zem_db_car-inspektion
                                   iv_aktstand   TYPE int4
                         EXPORTING ev_bischeck   TYPE zem_db_car-km_bis_check.
    ...
    CLASS-METHODS: owner IMPORTING iv_model   TYPE zem_de_car_model           "Importparameter aus Hauptprogramm
                                   ...
                                   iv_fahrnr  TYPE zem_db_owner-fahr_nr.
...
CLASS zem_cl_car IMPLEMENTATION.
  ...
  METHOD abruf.
    ...
    INSERT INTO zem_db_car VALUES @( VALUE #(     "Importparameter zum einfügen in die TAbelle
                        ...
                        brand = iv_brand
                        jahr = iv_jahr
                        inspektion = iv_inspektion
                       km_bis_check = ev_bischeck

                       ) ).

    ev_bischeck = iv_inspektion - iv_aktstand.
