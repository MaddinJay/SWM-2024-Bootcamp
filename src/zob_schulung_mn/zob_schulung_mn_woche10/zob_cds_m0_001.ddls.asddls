@AbapCatalog.sqlViewName: 'Z_OB_CDS_M0_001'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Mein erster CDS View mit einem Join'
define view ZOB_CDS_M0_001
  with parameters
    p_name : s_agncynam,
...
//      sbook.passbirth                                                                                                        as Passbirth,
      concat( stravelag.street,
              concat_with_space(',', concat_with_space(stravelag.city, concat_with_space(',', stravelag.country, 1), 1), 1)) as Adress,
//      stravelag.name                                                                                                         as AgancyName,
