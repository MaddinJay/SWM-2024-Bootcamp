@AbapCatalog.sqlViewName: 'ZOB_CDS_FB_JOIN'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'CD VIEWS - Übung 2 - JOIN'
define view ZOB_CDS_FB_001
...
sbook.agencynum as Agencynumber,
...
where stravelag.name = $parameters.p_name
