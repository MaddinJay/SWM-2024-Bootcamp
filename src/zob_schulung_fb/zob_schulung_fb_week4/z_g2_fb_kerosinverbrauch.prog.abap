*&---------------------------------------------------------------------*
*& Report z_g2_kerosinverbrauch
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT z_g2_fb_kerosinverbrauch.
...
START-OF-SELECTION.
  ...
  DATA: lo_kerosin        TYPE REF TO z_g2_leerflugzeug_menge,
        lo_passagiere     TYPE REF TO z_g2_passagiere_menge,
