@AbapCatalog.sqlViewName: 'ZOB_VW_TW_001'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'CDS View Buchungen'
define view ZOB_CDS_TW_BOOKING
    ...
    inner join   stravelag on sbook.agencynum = stravelag.agencynum
{
  ...
  key stravelag.agencynum as traAgencynum,
