*&---------------------------------------------------------------------*
*& Report ztw_flugzeuge_constructor
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ztw_flugzeuge_constructor.
...
*Definieren Sie in der Klasse die privaten Instanzattribute MV_WEIGHT ( SAPLANE_WEIGT) und MV_TANKCAP (SAPLANE_TANKCAP).
*Erweitern Sie die Implementierung des Konstruktors. Lesen Sie einen einzelnen Datensatz aus der DB Tabelle SAPLANE
*für den angegebenen Flugzeugtyp und setzen Sie die Attribute entsprechend.
