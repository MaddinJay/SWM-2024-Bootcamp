CLASS ztw_passagier_menge DEFINITION
 PUBLIC
  INHERITING FROM ztw_leerflugzeug_menge
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS: MI_Convert  TYPE p DECIMALS 2  VALUE '1.61',
               PE_Constant TYPE p DECIMALS 3 VALUE '0.045'.         "Internetrecherche: 4,5 l Kerosin pro Passagier pro 100 km
    ...
    METHODS berechnung_keromenge_personen
      ...
      METHODS get_kerosinp_l
       RETURNING VALUE(rv_kerosinp_l) LIKE kerosinp_l.
...
CLASS ztw_passagier_menge IMPLEMENTATION.
...
**********************************************************************
    ...
    ELSE.
      ls_kero_p-flugstrecke = ls_kero_p-flugstrecke.
    ENDIF.
...
**********************************************************************
  ...
  METHOD anzeige.
    ...
    WRITE |Die benötigte Menge Kerosin für die { Menge_pas } Passagiere beträgt { kerosinp_l } Liter |.      " Wenn Variable im Text stehen soll muss der Text in | und die Variable in {} stehen.
