CLASS ztw_leerflugzeug_menge DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    DATA: Connid          TYPE spfli-connid,
          ...
          planetype       TYPE sflight-planetype, "wenn sich der Flugzeugtype in der sflight ändert bekommt man es nur so mit
    ...
    CONSTANTS: Dichte_Kero TYPE p DECIMALS 2 VALUE '0.80'.
...
CLASS ztw_leerflugzeug_menge IMPLEMENTATION.
...
**********************************************************************
    ...
    kerosinmenge_kg = ( ls_kerosin-flugzeit * ls_kerosin-verbrauch ) / 60.         " Berechnung Kerosinmenge in kg; da Zeitangabe in Minuten erfolgt wird durch 60 geteilt
    kerosinmenge_l = kerosinmenge_kg / Dichte_kero.                                " Berechnung Kerosinmenge in Litern

*Cityto und cityfrom konnten nur hier definiert werden --> Denise fragen warum
