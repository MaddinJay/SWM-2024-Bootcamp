...
CLASS ltcl_zfd_testmapping DEFINITION FINAL FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.

  PRIVATE SECTION.
    DATA mo_cut TYPE REF TO zfd_testmapping.
...
CLASS ltcl_zfd_testmapping IMPLEMENTATION.

  METHOD setup. " wird vor jeder Testmethode aufgerufen!
    mo_cut = NEW #( ).
  ENDMETHOD.
