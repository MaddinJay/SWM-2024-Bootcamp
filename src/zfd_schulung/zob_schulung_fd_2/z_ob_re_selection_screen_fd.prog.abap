*&---------------------------------------------------------------------*
*& Report z_ob_re_selection_screen_fd
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT z_ob_re_selection_screen_fd.
...
START-OF-SELECTION.
  ...
  IF p_value1 IS INITIAL.
    ...
    MESSAGE lv_message TYPE 'X'. " DISPLAY LIKE 'W'. " Typ:  A (Abbruch),  S (Statuszeile), I (Information), E (Error) oder W (Warnung)
  ENDIF.
