...
CLASS lcl_vehicle IMPLEMENTATION.
  ...
  METHOD class_constructor.
    WRITE / 'Dies ist der Class-Constructor von lcl_vehicel'.
    kv_counter = 10.
  ENDMETHOD.

  METHOD stat_meth_vehic.
    WRITE / 'Dies ist Methode LCL_VEHICLE=>STAT_METH_VEHIC()'.
  ENDMETHOD.
