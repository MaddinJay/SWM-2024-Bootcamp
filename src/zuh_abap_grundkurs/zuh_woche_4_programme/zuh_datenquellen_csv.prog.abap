...
CALL FUNCTION 'GUI_UPLOAD'
  EXPORTING
    filename = 'C:\save\Zwischenspeicher\Datenquellen_organizations.csv'
  TABLES
...
CALL FUNCTION 'GUI_DOWNLOAD'
  EXPORTING
    filename = 'C:\save\Zwischenspeicher\Datenquellen_organizations2.csv'
  TABLES
    data_tab = lt_csv_data.
