...
CLASS LTCL_LV_RESERVE_STRING DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT FINAL.


  PRIVATE SECTION.

    DATA cut TYPE REF TO ZOB_LV_RESERVE_STRING.
...
CLASS LTCL_LV_RESERVE_STRING IMPLEMENTATION.

  METHOD setup.
    cut = NEW ZOB_LV_RESERVE_STRING( ).
  ENDMETHOD.
